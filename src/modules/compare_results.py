...
class ContentWidget(QWidget):
    """
    A widget to display the Compare Results screen (UI/UX).
    Includes a buttonBar at the top and a contentArea for displaying details.
    """
    def __init__(self):
        """
        Initialize the Compare Results screen UI/UX, setting up the layout, buttonBar, and contentArea.
        """
        super().__init__()
        ...
        # Label to display the name of the module (Compare Results)
