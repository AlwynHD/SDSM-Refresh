...
moduleName = "Scenario Generator"

class ContentWidget(QWidget):
    """
    A widget to display the Scenario Generator screen (UI/UX).
    Includes a buttonBar at the top and a contentArea for displaying details.
    """
    def __init__(self):
        """
        Initialize the Scenario Generator screen UI/UX, setting up the layout, buttonBar, and contentArea.
        """
        super().__init__()
        ...
        # Label to display the name of the module (Scenario Generator)
